...
define([
  ...
  Window.prototype = {
    ...
    slots: {
      move(e) {
        const event = convertMoveEvent(e);
        ...
        mousemove: function(e) {
          ...
          if (this._moving) {
            if (this.stayinspace) {
              ...
              const movingX = Math.max(0, event.pageX - this._moving.x);
              let minusX = 0;
              const movingY = Math.max(0, event.pageY - this._moving.y);
              let minusY = 0;
              if (
                movingX + this.view.el.clientWidth >
              ...
              if (
                movingY + this.view.el.clientHeight >
                this.space.el.clientHeight
              ) {
                minusY =
                  movingY +
